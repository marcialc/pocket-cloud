...
| gambatte (GB/GBC) | GPL-2.0 (`licenses/gambatte-COPYING`) | `v0.5.0 6924c76` | [libretro/gambatte-libretro@6924c76ba03dadddc6e97fa3660f3d3bc08faa94](https://github.com/libretro/gambatte-libretro/tree/6924c76ba03dadddc6e97fa3660f3d3bc08faa94) |
...
point to the Corresponding Source, e.g. an "Open-source licenses" page that
links the exact commits above. If we ever patch or rebuild a core, we must
